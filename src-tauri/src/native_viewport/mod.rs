...
impl Default for ViewportPalette {
    fn default() -> Self {
        Self {
            background: [29.0 / 255.0, 37.0 / 255.0, 49.0 / 255.0],
            panel: [22.0 / 255.0, 28.0 / 255.0, 38.0 / 255.0],
            header: [29.0 / 255.0, 35.0 / 255.0, 46.0 / 255.0],
            ui_edge: [53.0 / 255.0, 65.0 / 255.0, 82.0 / 255.0],
            ink: [231.0 / 255.0, 237.0 / 255.0, 246.0 / 255.0],
            mute: [154.0 / 255.0, 171.0 / 255.0, 191.0 / 255.0],
            accent: [75.0 / 255.0, 147.0 / 255.0, 238.0 / 255.0],
            grid_fine: [40.0 / 255.0, 50.0 / 255.0, 64.0 / 255.0],
            grid_major: [61.0 / 255.0, 76.0 / 255.0, 96.0 / 255.0],
