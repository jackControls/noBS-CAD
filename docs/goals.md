...
Manufacturing detail: [manufacturing/INDEX.md](manufacturing/INDEX.md) · OKRs:
[manufacturing/OKRs.md](manufacturing/OKRs.md).
...
| **Additive manufacturing** | **3MF** with materials/colors + brand slicer Metadata (Bambu default); **STL** fallback; **STEP** for engineering interchange. |
...
6. Grow MCP as a local automation/testing surface (see
   [mcp-harness.md](mcp-harness.md)); soft disclosure, file-bridge co-link,
   and optional UI launch are shipped — keep expanding coverage and reliability.
7. Harden 3MF materials + Bambu/Prusa/Orca/Cura export targets (see
   manufacturing OKRs).
...
- [proposed-architecture.md](proposed-architecture.md) — aspirational proposals
  (multi-window broker, agent-alignment files)
