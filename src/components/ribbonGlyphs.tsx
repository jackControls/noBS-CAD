...
const sources = { dimension, trim, extend, break: breakGlyph, offset, fillet, chamfer, moveCopy, mirror, select, rectPattern, circPattern, hv, fix, midpointC, coincident, tangent, equal, parallel, perpendicular, concentric, collinear, symmetry, extrude, revolve, sweep, loft, line, midpointLine, rect, circle, arc, slot, sketch, spline, point, finish, cancel, chevron };
